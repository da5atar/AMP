<?php
	...
	require_once("validation_functions1.php");
	
	$errors = array();
	$message = ""; // Initializing $ so the var doesn't return an error
...
<html lang="en">
	...
	<body>
		...
		<?php echo $message; ?><br />
		<?php echo form_errors($errors); ?> <!-- display the form errors if there are any --> 
